...
object Command {
  ...
  implicit val cmdEv2: Command[run]       = _isCommand[run]
  implicit val cmdEv3: Command[stop]      = _isCommand[stop]
  implicit val cmdEv4: Command[kill]      = _isCommand[kill]
  implicit val cmdEv5: Command[rm]        = _isCommand[rm]
  implicit val cmdEv6: Command[rmi]       = _isCommand[rmi]
  implicit val cmdEv7: Command[ps]        = _isCommand[ps]
